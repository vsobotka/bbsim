...
class TestBBCalc(unittest.TestCase):
    def run_script_test(self, original_stdout, script):
        with subprocess.Popen(
                ['python', '-c', 'from python.{script} import {script}; {script}(random_seed="battlebrothers")'.format(script=script)],
...
-----
"""
        self.run_script_test(original_stdout, 'BB1HanderBattery')
...
-----
"""
        self.run_script_test(original_stdout, 'BB2HanderBattery')
...
"""
        self.run_direct_test(original_stdout, 'BBAttackerVsEnemies')
...
-----
"""
        self.run_script_test(original_stdout, 'BBCalc')
...
"""
        self.run_direct_test(original_stdout, 'BBEnemiesVsDefender')
...
-----
"""
        self.run_direct_test(original_stdout, 'BBHitChance')
...
-----
"""
        self.run_direct_test(original_stdout, 'BBNimbleBattery')
...
-----
"""
        self.run_direct_test(original_stdout, 'BBRaisingHp')
