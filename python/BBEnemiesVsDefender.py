...
def BBEnemiesVsDefender(
        ...
        HornPlate=0,
        # Only select against melee attacks. +30 armor, 10% damage reduction. WARNING: Applies to all enemies if selected.
        UnholdFurCloak=0,
        # Only select against range attacks. +10 armor, 20% damage reduction. WARNING: Applies to all enemies if selected.
        SerpentSkin=0,
        # Only select in Handgonne tests. +30 armor, -2 Fatigue, 33% damage reduction. WARNING: Applies to all enemies if selected.
    ...
    def calc():
        global total
        Executioner = FrenziedDirewolf = Duelist = MasterArcher = Overseer = XbowMastery = Fearsome = TwoHander20 = CleaverMastery = HeadHunter = CripplingStrikes = DoubleGrip = CleaverBleed = SplitMan = Flail2HPound = FlailMastery = Berserker = Warrior = Warlord = Axe1H = Ambusher = 0
