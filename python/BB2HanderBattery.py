...
def BB2HanderBattery(
        ...
        HornPlate=0,
        # Only select against melee attacks. +30 armor, 10% damage reduction. WARNING: Applies to all weapons if selected.
        UnholdFurCloak=0,
        # Only select against range attacks. +10 armor, 20% damage reduction. WARNING: Applies to all weapons if selected.
        SerpentSkin=0,
        # Only select in Handgonne tests. +30 armor, -2 Fatigue, 33% damage reduction. WARNING: Applies to all weapons if selected.
