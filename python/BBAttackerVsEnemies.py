...
def BBAttackerVsEnemies(
    ...
    def calc(Ignore, Fatigue, Headshotchance, HHStack=0, Nimble=0, Boneplate=0, NineLives=0, SteelBrow=0, Forge=0, AdFurPad=0, Undead=0, Resilient=0):
        global total
        if DPreNimbleBro == 1:
    ...
    calc(Ignore, Fatigue, Headshotchance, HHStack)
    DPreAncientLegion = 0
