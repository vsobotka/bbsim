...
def BBHitChance(
        ...
        Puncture=0,
        # Dagger Puncture. Do not apply Double Grip. Does not apply Puncture's -15% hit chance, do that manually.
        Deathblow=0,
    ...
    for i in range(0, Trials):  # This will run a number of trials as set above by the trials variable.
        ...
        while hp > 0:  # Continue looping until death.
            ...
            if HitChanceCheck <= (
            min(95, HitChance + FastAdMod)):  # If hit chance roll is lower or equal to hit chance, hit is successful.
