...
def BBRaisingHp(
        ...
        Use_My_Input=0,
        # Set to 1 if you want a specific HP count tested. Otherwise it will test 60, 70, and so on until 140.
        Def_HP=75,
    ...
    def calc(Headshotchance, Ignore, HHStack):
                ...
                if head_roll <= Headshotchance:  # If headshot, do the following code blocks.
                    ...
                    if SplitMan == 1:
                        if BoneplateMod == 1:
                            ...
                            if body == 0:
                                ...
                                SMarmor_roll = random.randint(Mind,
                                                              Maxd) * .5 * ArmorMod * GladMod * IndomMod * AttachMod
                    ...
                    if SplitMan == 1:
                        ...
                        if helmet == 0:
                            ...
                            if helmet > 0:
                                SMhp_roll = max(0,
                                                (SMhp_roll * Ignore * NimbleMod * GladMod * IndomMod - (helmet * 0.1)))
                                helmet = math.ceil(helmet)
                                hp = math.ceil(hp - SMhp_roll)
                            else:
                                OverflowDamage = max(0, (
        ...
        if Undead != 1 and Savant != 1:
            ...
            if len(hits_until_1st_heavy_injury_chance) != 0:
                ...
                HitsToHeavyInjuryChancePercent = [(i, HitsToHeavyInjuryChanceCounter[i] / len(hits_until_death) * 100)
                                                  for i in HitsToHeavyInjuryChanceCounter]
        ...
        if Undead != 1 and Savant != 1:
            ...
            if len(hits_until_1st_heavy_injury_chance) == 0:
                ...
                if HeavyInjuryMean == 1:
                    print(
                        "Chance of first heavy injury in " + str(hits_to_1st_heavy_injury_chance) + " hits on average.")
    ...
    if Use_My_Input == 1:
        calc(Headshotchance, Ignore, HHStack)
