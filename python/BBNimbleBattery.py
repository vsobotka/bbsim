...
def BBNimbleBattery(
        ...
        Use_My_Input=0,
        # Set to 1 if you want your input used and 0 otherwise. For example, if you have famed armor you want to test then put it here. Common Nimble lines will run regardless.
        Def_Helmet=250,
        Def_Armor=200,
